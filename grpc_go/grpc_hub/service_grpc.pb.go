...
const (
	SimpleService_Ping_FullMethodName = "/SimpleService/Ping"
)
...
func (c *simpleServiceClient) Ping(ctx context.Context, in *PingMessage, opts ...grpc.CallOption) (*PingMessage, error) {
	out := new(PingMessage)
	err := c.cc.Invoke(ctx, SimpleService_Ping_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSimpleServiceServer) Ping(context.Context, *PingMessage) (*PingMessage, error) {
...
func _SimpleService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PingMessage)
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SimpleService_Ping_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleServiceServer).Ping(ctx, req.(*PingMessage))
	}
...
var SimpleService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Ping",
			Handler:    _SimpleService_Ping_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "grpc_hub/service.proto",
}
